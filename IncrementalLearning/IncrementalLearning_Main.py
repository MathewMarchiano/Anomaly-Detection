...
from AnomalyDetection.Graphing import IncrementalLearningVisuals
...
def getPredictions(unknownData, singleDataSamples, knownValidationData, listOfClassifiers, trainer):
    ...
    return unknownPreds, singleDataSamplesPreds, knownValidationPreds
...
def updatePredictions(trainer, codebook, unknownThresholdBuildingPreds, singleDataSamplesPreds,
    ...
    return unknownECOCPreds, singleDataSamplesECOCPreds, knownValidationECOCPreds

def getMinimumHammingDistanceLists(trainer, codebook, unknownThresholdBuildingPreds,
                                   singleDataSamplesPreds, knownThresholdBuildingPreds):
    ...
    return unknownThresholdBuildingHDs, singleDataSamplesHDs, knownThresholdBuildingHDs
